...
INTERNAL_UPDATES_DIR.mkdir(parents=True, exist_ok=True)
PLUGINS_ICON_CACHE.mkdir(parents=True, exist_ok=True)
...
tabs_disabled_style_new = """
    QPushButton { background-color: #b36f00; color: white; border-radius: 5px; border: none; background: transparent;}
